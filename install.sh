#!/usr/bin/env sh
# Universal installer for geoaoi. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/geoaoi.git"
echo "Installing geoaoi ..."
