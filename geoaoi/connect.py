"""Native cognis-connect emit for geoaoi — forward findings to any platform.

Maps geoaoi's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    geoaoi ... --format json | geoaoi-emit --to stix
    geoaoi-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
